...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "read_mem",
                         qmp_marshal_read_mem, 0, 0);
    qmp_register_command(cmds, "write_mem",
                         qmp_marshal_write_mem, 0, 0);
    qmp_register_command(cmds, "trigger_event",
                         qmp_marshal_trigger_event, 0, 0);
    qmp_register_command(cmds, "inject_gpio",
                         qmp_marshal_inject_gpio, 0, 0);
